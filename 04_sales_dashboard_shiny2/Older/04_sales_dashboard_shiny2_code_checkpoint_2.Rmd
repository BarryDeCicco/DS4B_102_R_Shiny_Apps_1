---
title: "Sales Dashboard"  # started by Barry from the code checkpoint for 3.2
output: 
...
# This mimics a click.  This whole code chunk is for the 'Reset' button, 
# so when that button is clicked, shinyjs::click() clicks the 'Apply' button.
# The function shinyjs::delay() delays that click until the filters can be
# updated. 
...
# This sets up the data to only change when the 'Apply' button is hit 
# (Section 4.3); the 
